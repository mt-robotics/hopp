...
This project assumes no server or file-system access to the live site. The live update must therefore happen through WordPress admin, and rollback is limited to what admin access allows.
